...
-- CreateEnum
CREATE TYPE "TipoAutoridad" AS ENUM ('PRESIDENTE', 'VICEPRESIDENTE', 'DIRECTOR_EVENTOS', 'DIRECTOR_ACADEMICO', 'DIRECTOR_FINANSAS', 'SECRETARIO_GENERAL', 'SECRETARIO_ACTAS', 'SECRETARIO_PRENSA');
