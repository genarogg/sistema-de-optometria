...
-- CreateEnum
CREATE TYPE "TipoAutoridad" AS ENUM ('PRESIDENTE', 'VICEPRESIDENTE', 'SECRETARIO_EVENTOS', 'SECRETARIO_ACADEMICO', 'SECRETARIO_FINANSAS', 'SECRETARIO_GENERAL', 'SECRETARIO_ACTAS', 'SECRETARIO_PRENSA');

-- CreateEnum
CREATE TYPE "TipoEvento" AS ENUM ('TALLER', 'DIPLOMADO', 'CONGRESO');

-- CreateEnum
CREATE TYPE "TipoSuscripcion" AS ENUM ('AGREMIADO', 'AGREMIADO_TSU', 'AGREMIADO_LICENCIADO', 'ESTUDIANTE', 'PROFESOR', 'VISITANTE');
...
CREATE TABLE "Evento" (
    ...
    "aliadoInstitucionNombre" TEXT,
    "aliadoAutorizoFirmaImg" TEXT,
    "aliadoAutorizoNombreFirma" TEXT,
    "aliadoAutorizoCargo" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
